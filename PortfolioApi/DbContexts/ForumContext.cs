    ...
    public class ForumContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Post>().HasData(
                new Post("Drake vs 21 Savage", "I prefer working with 21 Savage than Drake - I mean look at that smile.")
                {
                    PostId = 1,
                    ForumProfileId = 1,
                ...
                new Post("Is Josh a Good Brother", "The answer is yes - he puts up with a lot of my BS")
                {
                    ...
                    ForumProfileId = 2,
                    Likes = 4,
                    PhotoURL = "https://media-cldnry.s-nbcnews.com/image/upload/t_fit-760w,f_auto,q_auto:best/rockcms/2022-03/drake-josh-te-inline-220318-727172.jpg"
                },
                new Post("Which Croissants are Best?", "I didn't keep track, but the best ones are somewhere in Paris.")
                {
                    PostId = 3,
                    ForumProfileId = 3,
                }
            ...
            modelBuilder.Entity<Comment>().HasData(
                ...
                new Comment("He looks fantastic")
                {
                    CommentId = 2,
                    PostId = 1,
                    ForumProfileId = 3,
                ...
                new Comment("He got me the finest dope at the movie theater")
                {
                    CommentId = 3,
                    PostId = 2,
                    ForumProfileId = 1,
                ...
                new Comment("Wasn't this guy cancelled?")
                {
                    CommentId = 4,
                    PostId = 2,
                    ForumProfileId = 3,
