    ...
    public partial class initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumProfiles", x => x.ForumProfileId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interests_ForumProfiles_ForumProfileId",
                        column: x => x.ForumProfileId,
                        principalTable: "ForumProfiles",
                        principalColumn: "ForumProfileId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_ForumProfiles_ForumProfileId",
                        column: x => x.ForumProfileId,
                        principalTable: "ForumProfiles",
                        principalColumn: "ForumProfileId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "ForumProfiles",
                columns: new[] { "ForumProfileId", "Age", "DisplayName", "ProfileURL" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "PostId", "Flags", "ForumProfileId", "Likes", "PhotoURL", "Text", "Title" },
                values: new object[,]
                {
                    { 1, 0, 1, 0, "https://i.iheart.com/v3/re/new_assets/6059042c7270e66c113c9c35?ops=contain(1480,0)", "I prefer working with 21 Savage than Drake - I mean look at that smile.", "Drake vs 21 Savage" },
                    { 2, 0, 2, 4, "https://media-cldnry.s-nbcnews.com/image/upload/t_fit-760w,f_auto,q_auto:best/rockcms/2022-03/drake-josh-te-inline-220318-727172.jpg", "The answer is yes - he puts up with a lot of my BS", "Is Josh a Good Brother" },
                    { 3, 0, 3, 0, null, "I didn't keep track, but the best ones are somewhere in Paris.", "Which Croissants are Best?" }
                });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Flags", "ForumProfileId", "Likes", "PostId", "Text" },
                values: new object[,]
                {
                    { 1, 0, 2, 5, 1, "First." },
                    { 2, 0, 3, 3, 1, "He looks fantastic" },
                    { 3, 0, 1, 10, 2, "He got me the finest dope at the movie theater" },
                    { 4, 0, 3, 12, 2, "Wasn't this guy cancelled?" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interests_ForumProfileId",
                table: "Interests",
                column: "ForumProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_ForumProfileId",
                table: "Posts",
                column: "ForumProfileId");
        }
