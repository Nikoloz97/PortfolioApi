...
{
    /// <inheritdoc />
    public partial class Alter_ProfileCardsxForumProfile_Created_Comments_Posts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoURL = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => x.PostId);
                    table.ForeignKey(
                        name: "FK_Posts_ProfileCards_ProfileCardID",
                        column: x => x.ProfileCardID,
                        principalTable: "ProfileCards",
                        principalColumn: "ProfileCardID",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ProfileCardProfileCard",
                columns: table => new
                {
                    FollowersProfileCardID = table.Column<int>(type: "INTEGER", nullable: false),
                    FollowingProfileCardID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileCardProfileCard", x => new { x.FollowersProfileCardID, x.FollowingProfileCardID });
                    table.ForeignKey(
                        name: "FK_ProfileCardProfileCard_ProfileCards_FollowersProfileCardID",
                        column: x => x.FollowersProfileCardID,
                        principalTable: "ProfileCards",
                        principalColumn: "ProfileCardID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileCardProfileCard_ProfileCards_FollowingProfileCardID",
                        column: x => x.FollowingProfileCardID,
                        principalTable: "ProfileCards",
                        principalColumn: "ProfileCardID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileURL = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_ProfileCards_ForumProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_ProfileCardID",
                table: "Posts",
                column: "ProfileCardID");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileCardProfileCard_FollowingProfileCardID",
                table: "ProfileCardProfileCard",
                column: "FollowingProfileCardID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ProfileCards_User_UserId",
                table: "ProfileCards",
                column: "UserId",
                principalTable: "User",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ProfileCards",
                columns: new[] { "ProfileCardID", "Age", "FirstName", "LastName", "ProfileURL" },
                values: new object[,]
                {
