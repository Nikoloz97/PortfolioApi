...
namespace PortfolioApi.Migrations.User
{
    ...
    [Migration("20240312035808_Added_GeoCards")]
    partial class Added_GeoCards
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PortfolioApi.Entities.Forum.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = 1,
                            CommentDate = new DateTime(2023, 7, 12, 20, 38, 15, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            CommentId = 2,
                            CommentDate = new DateTime(2023, 7, 13, 20, 38, 15, 0, DateTimeKind.Unspecified),
                            DisplayName = "Drake Parker",
                            Flags = 0,
                            Likes = 3,
                            PostId = 1,
                            ...
                            Text = "He looks fantastic"
                        },
                        new
                        {
                            CommentId = 3,
                            CommentDate = new DateTime(2023, 7, 14, 20, 38, 15, 0, DateTimeKind.Unspecified),
                            ...
                            Text = "He got me the finest dope at the movie theater"
                        },
                        new
                        {
                            CommentId = 4,
                            CommentDate = new DateTime(2023, 7, 15, 20, 38, 15, 0, DateTimeKind.Unspecified),
                            DisplayName = "Tom Segura",
                            Flags = 0,
                            Likes = 12,
                            PostId = 2,
                            ProfileUrl = "data:image/jpeg;base64,",
                            Text = "Wasn't this guy cancelled?"
                        });
                });
            ...
            modelBuilder.Entity("PortfolioApi.Entities.Forum.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PostedDate = new DateTime(2023, 7, 9, 17, 38, 15, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            Likes = 0,
                            PhotoURL = "https://i.iheart.com/v3/re/new_assets/6059042c7270e66c113c9c35?ops=contain(1480,0)",
                            PostedDate = new DateTime(2023, 7, 10, 17, 38, 15, 0, DateTimeKind.Unspecified),
                            Text = "Test Text",
                            Title = "Test Title"
                        },
                        new
                        {
                            ...
                            Likes = 0,
                            PhotoURL = "https://i.iheart.com/v3/re/new_assets/6059042c7270e66c113c9c35?ops=contain(1480,0)",
                            PostedDate = new DateTime(2023, 7, 11, 17, 38, 15, 0, DateTimeKind.Unspecified),
                            Text = "Test Text 2",
                            Title = "Test Title 2"
                        },
                        new
                        {
                            ...
                            Likes = 0,
                            PhotoURL = "https://i.iheart.com/v3/re/new_assets/6059042c7270e66c113c9c35?ops=contain(1480,0)",
                            PostedDate = new DateTime(2023, 7, 12, 17, 38, 15, 0, DateTimeKind.Unspecified),
                            Text = "Test Text 3",
                            Title = "Test Title 3"
                        },
                        new
                        {
                            ...
                            Likes = 0,
                            PhotoURL = "https://i.iheart.com/v3/re/new_assets/6059042c7270e66c113c9c35?ops=contain(1480,0)",
                            PostedDate = new DateTime(2023, 7, 13, 17, 38, 15, 0, DateTimeKind.Unspecified),
                            Text = "Test Text 4",
                            Title = "Test Title 4"
                        },
                        new
                        {
                            ...
                            PostedDate = new DateTime(2023, 7, 10, 19, 38, 15, 0, DateTimeKind.Unspecified),
                            Text = "The answer is yes - he puts up with a lot of my BS",
                            Title = "Is Josh a Good Brother"
                        },
                        new
                        {
                            PostId = 3,
            ...
            modelBuilder.Entity("PortfolioApi.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "FHendrix@gmail.com",
                            FirstName = "Future",
                            LastName = "Hendrix",
                            Password = "Nikamaria97",
                            ProfileURL = "data:image/jpeg;base64,",
                            Username = "FHendrix09"
                        },
                        new
                        {
                            UserId = 2,
                            Bio = "Hey there! My name is Drake Parker, welcome to my page.",
                        ...
                        {
                            UserId = 3,
                            Bio = "Hey there! My name is Tom Segura, welcome to my page.",
                            Email = "TSegura@gmail.com",
                            FirstName = "Tom",
                            LastName = "Segura",
                            Password = "Nikamaria97",
                            ProfileURL = "data:image/jpeg;base64,",
